...
/*   Updated: 2020/04/08 19:11:49 by Maran         ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void		texture(t_base *base)
{
	...
	base->tex_c.png_img = mlx_png_file_to_image(base->mlx.mlx,"./Textures_png/purplestone.png", &base->game.texWidth, &base->game.texHeight);
